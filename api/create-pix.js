export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('Asaas customer search:', JSON.stringify(searchData));
    ...
    if (searchData.data && searchData.data.length > 0) {
      ...
      console.log('Asaas customer create response:', JSON.stringify(custData));
      if (!custData.id) {
    ...
    console.log('Criando pagamento PIX:', JSON.stringify(paymentBody));
